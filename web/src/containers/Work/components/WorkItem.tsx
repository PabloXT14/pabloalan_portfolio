    ...
    >
      ...
      >
        {work.imgUrl ? (
          ...
          <div className="flex h-full w-full flex-col items-center justify-center rounded-lg bg-lightGray object-cover">
      ...
      <div
        className={twMerge(
          styles.appFlex,
          'relative h-fit w-full flex-col p-2',
        )}
      >
        <h4 className={twMerge(styles.boldText, 'mt-4 text-center')}>
          {work.title}
        </h4>
        ...
        >
          <p className={twMerge(styles.pText)}>{work.tags[0]}</p>
        </div>
      </div>
